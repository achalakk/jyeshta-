...
import {COMMONPATH,BLOGIMAGEPATH} from "../core/utils";
...
export default class App extends React.Component {
	...
	async componentDidMount() {
		console.log(this.props.route.params.data.result);
		try {
		...
		return playbackInstance ? (
			...
			<View style={styles.trackInfo}>
				<Image
					...
					source={{ uri: BLOGIMAGEPATH+this.state.audioBookPlaylist[currentIndex].imageSource}}></Image>
